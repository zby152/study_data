...
sfood 				dw 	0
sdct 				dw 	0
sbody 		times  200	dw 	0
skeyboard			dw	0
sflag				db	0
_s_menu				db	"Press s to Start Game!",0
_s_esc				db	"Press Esc to Exit!",0
_s_score			db	"score: ",0
s_scores			dw	0
...
;skeyboard		equ	_skeyboard	- $$
;sflag			equ	_sflag		-$$
s_menu			equ	_s_menu		- $$
s_esc			equ	_s_esc		- $$
s_score			equ	_s_score	- $$
;s_scores		equ	_s_scores	- $$
...
.021h:		Gate	SelectorCode32,	   KeybordHandler,    0, DA_386IGate
%rep 94
		Gate	SelectorCode32, SpuriousHandler,      0, DA_386IGate
%endrep
...
_KeybordHandler:
KeybordHandler equ       _KeybordHandler-$$
