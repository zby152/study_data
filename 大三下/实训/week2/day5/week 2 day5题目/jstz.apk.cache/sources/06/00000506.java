...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public abstract ShowableListMenu mo75getPopup();
    ...
    protected boolean onForwardingStarted() {
        ShowableListMenu mo75getPopup = mo75getPopup();
        if (mo75getPopup == null || mo75getPopup.isShowing()) {
            return true;
        }
        mo75getPopup.show();
        return true;
    ...
    private boolean onTouchForwarded(MotionEvent motionEvent) {
        ...
        View view = this.mSrc;
        ShowableListMenu mo75getPopup = mo75getPopup();
        if (mo75getPopup == null || !mo75getPopup.isShowing() || (dropDownListView = (DropDownListView) mo75getPopup.getListView()) == null || !dropDownListView.isShown()) {
            return false;
        }
