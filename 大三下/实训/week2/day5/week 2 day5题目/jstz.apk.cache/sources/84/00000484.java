...
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem {
    ...
    public MenuItem setShowAsActionFlags(int i) {
        ((SupportMenuItem) this.mWrappedObject).mo64setShowAsActionFlags(i);
        return this;
    }
    ...
    public MenuItem setActionView(View view) {
        ...
        ((SupportMenuItem) this.mWrappedObject).mo62setActionView(view);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setActionView(int i) {
        ((SupportMenuItem) this.mWrappedObject).mo61setActionView(i);
        View actionView = ((SupportMenuItem) this.mWrappedObject).getActionView();
        if (actionView instanceof CollapsibleActionView) {
            ((SupportMenuItem) this.mWrappedObject).mo62setActionView(new CollapsibleActionViewWrapper(actionView));
        }
        return this;
    }
    ...
    public MenuItem setContentDescription(CharSequence charSequence) {
        ((SupportMenuItem) this.mWrappedObject).mo63setContentDescription(charSequence);
        return this;
    }
    ...
    public MenuItem setTooltipText(CharSequence charSequence) {
        ((SupportMenuItem) this.mWrappedObject).mo65setTooltipText(charSequence);
        return this;
    }
