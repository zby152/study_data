...
public class Toolbar extends ViewGroup {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            LayoutParams mo79generateDefaultLayoutParams = mo79generateDefaultLayoutParams();
            mo79generateDefaultLayoutParams.gravity = 8388613 | (this.mButtonGravity & 112);
            this.mMenuView.setLayoutParams(mo79generateDefaultLayoutParams);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams mo79generateDefaultLayoutParams = mo79generateDefaultLayoutParams();
            mo79generateDefaultLayoutParams.gravity = 8388611 | (this.mButtonGravity & 112);
            this.mNavButtonView.setLayoutParams(mo79generateDefaultLayoutParams);
        }
    }
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            LayoutParams mo79generateDefaultLayoutParams = mo79generateDefaultLayoutParams();
            mo79generateDefaultLayoutParams.gravity = 8388611 | (this.mButtonGravity & 112);
            mo79generateDefaultLayoutParams.mViewType = 2;
            this.mCollapseButtonView.setLayoutParams(mo79generateDefaultLayoutParams);
    ...
    private void addSystemView(View view, boolean z) {
        ...
        if (layoutParams2 == null) {
            layoutParams = mo79generateDefaultLayoutParams();
        } else if (!checkLayoutParams(layoutParams2)) {
            layoutParams = mo81generateLayoutParams(layoutParams2);
        } else {
    ...
    public LayoutParams mo80generateLayoutParams(AttributeSet attributeSet) {
    ...
    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo81generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
    ...
    public LayoutParams mo79generateDefaultLayoutParams() {
    ...
    public class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != toolbar3) {
                ...
                LayoutParams mo79generateDefaultLayoutParams = Toolbar.this.mo79generateDefaultLayoutParams();
                mo79generateDefaultLayoutParams.gravity = 8388611 | (Toolbar.this.mButtonGravity & 112);
                mo79generateDefaultLayoutParams.mViewType = 2;
                Toolbar.this.mExpandedActionView.setLayoutParams(mo79generateDefaultLayoutParams);
