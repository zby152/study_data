...
public class ConstraintSet {
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            this.mConstraints.put(num, constraintSet.mConstraints.get(num).m4clone());
        }
    }
    ...
    public void applyToInternal(ConstraintLayout constraintLayout) {
        ...
        while (it.hasNext()) {
            ...
            if (constraint2.mHelperType != -1 && constraint2.mHelperType == 1) {
                ...
                ConstraintLayout.LayoutParams mo2generateDefaultLayoutParams = constraintLayout.mo2generateDefaultLayoutParams();
                barrier2.validateParams();
                constraint2.applyTo(mo2generateDefaultLayoutParams);
                constraintLayout.addView(barrier2, mo2generateDefaultLayoutParams);
            }
            if (constraint2.mIsGuideline) {
                Guideline guideline = new Guideline(constraintLayout.getContext());
                guideline.setId(num.intValue());
                ConstraintLayout.LayoutParams mo2generateDefaultLayoutParams2 = constraintLayout.mo2generateDefaultLayoutParams();
                constraint2.applyTo(mo2generateDefaultLayoutParams2);
                constraintLayout.addView(guideline, mo2generateDefaultLayoutParams2);
            }
        }
    }
