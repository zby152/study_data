...
public final class R {
    ...
    public static final class styleable {
        ...
        public static final int[] ActionBar = {an.droid.j.R.attr.background, an.droid.j.R.attr.backgroundSplit, an.droid.j.R.attr.backgroundStacked, an.droid.j.R.attr.contentInsetEnd, an.droid.j.R.attr.contentInsetEndWithActions, an.droid.j.R.attr.contentInsetLeft, an.droid.j.R.attr.contentInsetRight, an.droid.j.R.attr.contentInsetStart, an.droid.j.R.attr.contentInsetStartWithNavigation, an.droid.j.R.attr.customNavigationLayout, an.droid.j.R.attr.displayOptions, an.droid.j.R.attr.divider, an.droid.j.R.attr.elevation, an.droid.j.R.attr.height, an.droid.j.R.attr.hideOnContentScroll, an.droid.j.R.attr.homeAsUpIndicator, an.droid.j.R.attr.homeLayout, an.droid.j.R.attr.icon, an.droid.j.R.attr.indeterminateProgressStyle, an.droid.j.R.attr.itemPadding, an.droid.j.R.attr.logo, an.droid.j.R.attr.navigationMode, an.droid.j.R.attr.popupTheme, an.droid.j.R.attr.progressBarPadding, an.droid.j.R.attr.progressBarStyle, an.droid.j.R.attr.subtitle, an.droid.j.R.attr.subtitleTextStyle, an.droid.j.R.attr.title, an.droid.j.R.attr.titleTextStyle};
        public static final int[] ActionBarLayout = {16842931};
        public static final int[] ActionMenuItemView = {16843071};
        public static final int[] ActionMenuView = new int[0];
        public static final int[] ActionMode = {an.droid.j.R.attr.background, an.droid.j.R.attr.backgroundSplit, an.droid.j.R.attr.closeItemLayout, an.droid.j.R.attr.height, an.droid.j.R.attr.subtitleTextStyle, an.droid.j.R.attr.titleTextStyle};
        public static final int[] ActivityChooserView = {an.droid.j.R.attr.expandActivityOverflowButtonDrawable, an.droid.j.R.attr.initialActivityCount};
        public static final int[] AlertDialog = {16842994, an.droid.j.R.attr.buttonIconDimen, an.droid.j.R.attr.buttonPanelSideLayout, an.droid.j.R.attr.listItemLayout, an.droid.j.R.attr.listLayout, an.droid.j.R.attr.multiChoiceItemLayout, an.droid.j.R.attr.showTitle, an.droid.j.R.attr.singleChoiceItemLayout};
        ...
        public static final int[] AppCompatImageView = {16843033, an.droid.j.R.attr.srcCompat, an.droid.j.R.attr.tint, an.droid.j.R.attr.tintMode};
        public static final int[] AppCompatSeekBar = {16843074, an.droid.j.R.attr.tickMark, an.droid.j.R.attr.tickMarkTint, an.droid.j.R.attr.tickMarkTintMode};
        public static final int[] AppCompatTextHelper = {16842804, 16843117, 16843118, 16843119, 16843120, 16843666, 16843667};
        public static final int[] AppCompatTextView = {16842804, an.droid.j.R.attr.autoSizeMaxTextSize, an.droid.j.R.attr.autoSizeMinTextSize, an.droid.j.R.attr.autoSizePresetSizes, an.droid.j.R.attr.autoSizeStepGranularity, an.droid.j.R.attr.autoSizeTextType, an.droid.j.R.attr.firstBaselineToTopHeight, an.droid.j.R.attr.fontFamily, an.droid.j.R.attr.lastBaselineToBottomHeight, an.droid.j.R.attr.lineHeight, an.droid.j.R.attr.textAllCaps};
        public static final int[] AppCompatTheme = {16842839, 16842926, an.droid.j.R.attr.actionBarDivider, an.droid.j.R.attr.actionBarItemBackground, an.droid.j.R.attr.actionBarPopupTheme, an.droid.j.R.attr.actionBarSize, an.droid.j.R.attr.actionBarSplitStyle, an.droid.j.R.attr.actionBarStyle, an.droid.j.R.attr.actionBarTabBarStyle, an.droid.j.R.attr.actionBarTabStyle, an.droid.j.R.attr.actionBarTabTextStyle, an.droid.j.R.attr.actionBarTheme, an.droid.j.R.attr.actionBarWidgetTheme, an.droid.j.R.attr.actionButtonStyle, an.droid.j.R.attr.actionDropDownStyle, an.droid.j.R.attr.actionMenuTextAppearance, an.droid.j.R.attr.actionMenuTextColor, an.droid.j.R.attr.actionModeBackground, an.droid.j.R.attr.actionModeCloseButtonStyle, an.droid.j.R.attr.actionModeCloseDrawable, an.droid.j.R.attr.actionModeCopyDrawable, an.droid.j.R.attr.actionModeCutDrawable, an.droid.j.R.attr.actionModeFindDrawable, an.droid.j.R.attr.actionModePasteDrawable, an.droid.j.R.attr.actionModePopupWindowStyle, an.droid.j.R.attr.actionModeSelectAllDrawable, an.droid.j.R.attr.actionModeShareDrawable, an.droid.j.R.attr.actionModeSplitBackground, an.droid.j.R.attr.actionModeStyle, an.droid.j.R.attr.actionModeWebSearchDrawable, an.droid.j.R.attr.actionOverflowButtonStyle, an.droid.j.R.attr.actionOverflowMenuStyle, an.droid.j.R.attr.activityChooserViewStyle, an.droid.j.R.attr.alertDialogButtonGroupStyle, an.droid.j.R.attr.alertDialogCenterButtons, an.droid.j.R.attr.alertDialogStyle, an.droid.j.R.attr.alertDialogTheme, an.droid.j.R.attr.autoCompleteTextViewStyle, an.droid.j.R.attr.borderlessButtonStyle, an.droid.j.R.attr.buttonBarButtonStyle, an.droid.j.R.attr.buttonBarNegativeButtonStyle, an.droid.j.R.attr.buttonBarNeutralButtonStyle, an.droid.j.R.attr.buttonBarPositiveButtonStyle, an.droid.j.R.attr.buttonBarStyle, an.droid.j.R.attr.buttonStyle, an.droid.j.R.attr.buttonStyleSmall, an.droid.j.R.attr.checkboxStyle, an.droid.j.R.attr.checkedTextViewStyle, an.droid.j.R.attr.colorAccent, an.droid.j.R.attr.colorBackgroundFloating, an.droid.j.R.attr.colorButtonNormal, an.droid.j.R.attr.colorControlActivated, an.droid.j.R.attr.colorControlHighlight, an.droid.j.R.attr.colorControlNormal, an.droid.j.R.attr.colorError, an.droid.j.R.attr.colorPrimary, an.droid.j.R.attr.colorPrimaryDark, an.droid.j.R.attr.colorSwitchThumbNormal, an.droid.j.R.attr.controlBackground, an.droid.j.R.attr.dialogCornerRadius, an.droid.j.R.attr.dialogPreferredPadding, an.droid.j.R.attr.dialogTheme, an.droid.j.R.attr.dividerHorizontal, an.droid.j.R.attr.dividerVertical, an.droid.j.R.attr.dropDownListViewStyle, an.droid.j.R.attr.dropdownListPreferredItemHeight, an.droid.j.R.attr.editTextBackground, an.droid.j.R.attr.editTextColor, an.droid.j.R.attr.editTextStyle, an.droid.j.R.attr.homeAsUpIndicator, an.droid.j.R.attr.imageButtonStyle, an.droid.j.R.attr.listChoiceBackgroundIndicator, an.droid.j.R.attr.listDividerAlertDialog, an.droid.j.R.attr.listMenuViewStyle, an.droid.j.R.attr.listPopupWindowStyle, an.droid.j.R.attr.listPreferredItemHeight, an.droid.j.R.attr.listPreferredItemHeightLarge, an.droid.j.R.attr.listPreferredItemHeightSmall, an.droid.j.R.attr.listPreferredItemPaddingLeft, an.droid.j.R.attr.listPreferredItemPaddingRight, an.droid.j.R.attr.panelBackground, an.droid.j.R.attr.panelMenuListTheme, an.droid.j.R.attr.panelMenuListWidth, an.droid.j.R.attr.popupMenuStyle, an.droid.j.R.attr.popupWindowStyle, an.droid.j.R.attr.radioButtonStyle, an.droid.j.R.attr.ratingBarStyle, an.droid.j.R.attr.ratingBarStyleIndicator, an.droid.j.R.attr.ratingBarStyleSmall, an.droid.j.R.attr.searchViewStyle, an.droid.j.R.attr.seekBarStyle, an.droid.j.R.attr.selectableItemBackground, an.droid.j.R.attr.selectableItemBackgroundBorderless, an.droid.j.R.attr.spinnerDropDownItemStyle, an.droid.j.R.attr.spinnerStyle, an.droid.j.R.attr.switchStyle, an.droid.j.R.attr.textAppearanceLargePopupMenu, an.droid.j.R.attr.textAppearanceListItem, an.droid.j.R.attr.textAppearanceListItemSecondary, an.droid.j.R.attr.textAppearanceListItemSmall, an.droid.j.R.attr.textAppearancePopupMenuHeader, an.droid.j.R.attr.textAppearanceSearchResultSubtitle, an.droid.j.R.attr.textAppearanceSearchResultTitle, an.droid.j.R.attr.textAppearanceSmallPopupMenu, an.droid.j.R.attr.textColorAlertDialogListItem, an.droid.j.R.attr.textColorSearchUrl, an.droid.j.R.attr.toolbarNavigationButtonStyle, an.droid.j.R.attr.toolbarStyle, an.droid.j.R.attr.tooltipForegroundColor, an.droid.j.R.attr.tooltipFrameBackground, an.droid.j.R.attr.viewInflaterClass, an.droid.j.R.attr.windowActionBar, an.droid.j.R.attr.windowActionBarOverlay, an.droid.j.R.attr.windowActionModeOverlay, an.droid.j.R.attr.windowFixedHeightMajor, an.droid.j.R.attr.windowFixedHeightMinor, an.droid.j.R.attr.windowFixedWidthMajor, an.droid.j.R.attr.windowFixedWidthMinor, an.droid.j.R.attr.windowMinWidthMajor, an.droid.j.R.attr.windowMinWidthMinor, an.droid.j.R.attr.windowNoTitle};
        public static final int[] ButtonBarLayout = {an.droid.j.R.attr.allowStacking};
        public static final int[] ColorStateListItem = {16843173, 16843551, an.droid.j.R.attr.alpha};
        public static final int[] CompoundButton = {16843015, an.droid.j.R.attr.buttonTint, an.droid.j.R.attr.buttonTintMode};
        ...
        public static final int[] DrawerArrowToggle = {an.droid.j.R.attr.arrowHeadLength, an.droid.j.R.attr.arrowShaftLength, an.droid.j.R.attr.barLength, an.droid.j.R.attr.color, an.droid.j.R.attr.drawableSize, an.droid.j.R.attr.gapBetweenBars, an.droid.j.R.attr.spinBars, an.droid.j.R.attr.thickness};
        ...
        public static final int[] LinearLayoutCompat = {16842927, 16842948, 16843046, 16843047, 16843048, an.droid.j.R.attr.divider, an.droid.j.R.attr.dividerPadding, an.droid.j.R.attr.measureWithLargestChild, an.droid.j.R.attr.showDividers};
        ...
        public static final int[] MenuItem = {16842754, 16842766, 16842960, 16843014, 16843156, 16843230, 16843231, 16843233, 16843234, 16843235, 16843236, 16843237, 16843375, an.droid.j.R.attr.actionLayout, an.droid.j.R.attr.actionProviderClass, an.droid.j.R.attr.actionViewClass, an.droid.j.R.attr.alphabeticModifiers, an.droid.j.R.attr.contentDescription, an.droid.j.R.attr.iconTint, an.droid.j.R.attr.iconTintMode, an.droid.j.R.attr.numericModifiers, an.droid.j.R.attr.showAsAction, an.droid.j.R.attr.tooltipText};
        public static final int[] MenuView = {16842926, 16843052, 16843053, 16843054, 16843055, 16843056, 16843057, an.droid.j.R.attr.preserveIconSpacing, an.droid.j.R.attr.subMenuArrow};
        public static final int[] PopupWindow = {16843126, 16843465, an.droid.j.R.attr.overlapAnchor};
        public static final int[] PopupWindowBackgroundState = {an.droid.j.R.attr.state_above_anchor};
        public static final int[] RecycleListView = {an.droid.j.R.attr.paddingBottomNoButtons, an.droid.j.R.attr.paddingTopNoTitle};
        public static final int[] SearchView = {16842970, 16843039, 16843296, 16843364, an.droid.j.R.attr.closeIcon, an.droid.j.R.attr.commitIcon, an.droid.j.R.attr.defaultQueryHint, an.droid.j.R.attr.goIcon, an.droid.j.R.attr.iconifiedByDefault, an.droid.j.R.attr.layout, an.droid.j.R.attr.queryBackground, an.droid.j.R.attr.queryHint, an.droid.j.R.attr.searchHintIcon, an.droid.j.R.attr.searchIcon, an.droid.j.R.attr.submitBackground, an.droid.j.R.attr.suggestionRowLayout, an.droid.j.R.attr.voiceIcon};
        public static final int[] Spinner = {16842930, 16843126, 16843131, 16843362, an.droid.j.R.attr.popupTheme};
        ...
        public static final int[] SwitchCompat = {16843044, 16843045, 16843074, an.droid.j.R.attr.showText, an.droid.j.R.attr.splitTrack, an.droid.j.R.attr.switchMinWidth, an.droid.j.R.attr.switchPadding, an.droid.j.R.attr.switchTextAppearance, an.droid.j.R.attr.thumbTextPadding, an.droid.j.R.attr.thumbTint, an.droid.j.R.attr.thumbTintMode, an.droid.j.R.attr.track, an.droid.j.R.attr.trackTint, an.droid.j.R.attr.trackTintMode};
        public static final int[] TextAppearance = {16842901, 16842902, 16842903, 16842904, 16842906, 16842907, 16843105, 16843106, 16843107, 16843108, 16843692, an.droid.j.R.attr.fontFamily, an.droid.j.R.attr.textAllCaps};
        public static final int[] Toolbar = {16842927, 16843072, an.droid.j.R.attr.buttonGravity, an.droid.j.R.attr.collapseContentDescription, an.droid.j.R.attr.collapseIcon, an.droid.j.R.attr.contentInsetEnd, an.droid.j.R.attr.contentInsetEndWithActions, an.droid.j.R.attr.contentInsetLeft, an.droid.j.R.attr.contentInsetRight, an.droid.j.R.attr.contentInsetStart, an.droid.j.R.attr.contentInsetStartWithNavigation, an.droid.j.R.attr.logo, an.droid.j.R.attr.logoDescription, an.droid.j.R.attr.maxButtonHeight, an.droid.j.R.attr.navigationContentDescription, an.droid.j.R.attr.navigationIcon, an.droid.j.R.attr.popupTheme, an.droid.j.R.attr.subtitle, an.droid.j.R.attr.subtitleTextAppearance, an.droid.j.R.attr.subtitleTextColor, an.droid.j.R.attr.title, an.droid.j.R.attr.titleMargin, an.droid.j.R.attr.titleMarginBottom, an.droid.j.R.attr.titleMarginEnd, an.droid.j.R.attr.titleMarginStart, an.droid.j.R.attr.titleMarginTop, an.droid.j.R.attr.titleMargins, an.droid.j.R.attr.titleTextAppearance, an.droid.j.R.attr.titleTextColor};
        public static final int[] View = {16842752, 16842970, an.droid.j.R.attr.paddingEnd, an.droid.j.R.attr.paddingStart, an.droid.j.R.attr.theme};
        public static final int[] ViewBackgroundHelper = {16842964, an.droid.j.R.attr.backgroundTint, an.droid.j.R.attr.backgroundTintMode};
