    ...
    */
    ...
    public Drawable mutate() {
        if (!this.mMutated && super.mutate() == this) {
            DrawableContainerState mo53cloneConstantState = mo53cloneConstantState();
            mo53cloneConstantState.mutate();
            setConstantState(mo53cloneConstantState);
    ...
    DrawableContainerState mo53cloneConstantState() {
        return this.mDrawableContainerState;
    }
