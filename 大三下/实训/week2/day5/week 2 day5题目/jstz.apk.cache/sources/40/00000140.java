...
public final class R {
    ...
    public static final class styleable {
        ...
        public static final int[] ColorStateListItem = {16843173, 16843551, an.droid.j.R.attr.alpha};
        public static final int[] CoordinatorLayout = {an.droid.j.R.attr.keylines, an.droid.j.R.attr.statusBarBackground};
        public static final int[] CoordinatorLayout_Layout = {16842931, an.droid.j.R.attr.layout_anchor, an.droid.j.R.attr.layout_anchorGravity, an.droid.j.R.attr.layout_behavior, an.droid.j.R.attr.layout_dodgeInsetEdges, an.droid.j.R.attr.layout_insetEdge, an.droid.j.R.attr.layout_keyline};
        public static final int[] FontFamily = {an.droid.j.R.attr.fontProviderAuthority, an.droid.j.R.attr.fontProviderCerts, an.droid.j.R.attr.fontProviderFetchStrategy, an.droid.j.R.attr.fontProviderFetchTimeout, an.droid.j.R.attr.fontProviderPackage, an.droid.j.R.attr.fontProviderQuery};
        public static final int[] FontFamilyFont = {16844082, 16844083, 16844095, 16844143, 16844144, an.droid.j.R.attr.font, an.droid.j.R.attr.fontStyle, an.droid.j.R.attr.fontVariationSettings, an.droid.j.R.attr.fontWeight, an.droid.j.R.attr.ttcIndex};
