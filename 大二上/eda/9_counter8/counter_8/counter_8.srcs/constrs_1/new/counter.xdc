...
set_property IOSTANDARD LVCMOS18 [get_ports {oDisplay[6]}]
set_property IOSTANDARD LVCMOS18 [get_ports {oDisplay[5]}]
set_property IOSTANDARD LVCMOS18 [get_ports {oDisplay[4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {oDisplay[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {oDisplay[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {oDisplay[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {oDisplay[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {oQ[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {oQ[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {oQ[0]}]
