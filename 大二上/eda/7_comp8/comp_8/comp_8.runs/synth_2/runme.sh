...
HD_PWD='F:/eda/7_comp8/comp_8/comp_8.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log comp_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comp_8.tcl
