...
HD_PWD='F:/eda/7_comp8/comp_8/comp_8.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log comp_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comp_8.tcl -notrace
