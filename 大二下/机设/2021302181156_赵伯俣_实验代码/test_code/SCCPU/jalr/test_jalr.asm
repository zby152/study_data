...
label1: slt  $4, $7, $2         # $4 = (3 < 5) = 1      0A      28      00e2202a
        ...
        addi $7, $7, 77         # $7=84                         34
        jalr $5, $7               # jump to label3 ,$5=3c       38
label4: sw   $7, 244($3)        # [256] = 7             0D      3c     ac6700f4
        lw   $2, 256($0)        # $2 = [256] = 7        0E      40    8c020100
        jal  label2             # should be taken       0F      44    0c000011
        addi $2, $0, 1          # shouldn't happen      10      48    20020001
label2: sw   $2, 260($0)        # write adr 260 = 7     11      4c   ac020104
loop:   j    loop               # dead loop             12      50    08000012
label3: addi $7, $7, 5          # $7=89                        54
        j label4                #                               58
