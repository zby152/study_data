...
#
# Generated by Vivado on Fri Mar 24 09:48:30 +0800 2023
# SW Build 2086221 on Fri Dec 15 20:55:39 MST 2017
#
# Copyright 1986-2017 Xilinx, Inc. All Rights Reserved. 
#
# usage: dem.sh [-help]
# usage: dem.sh [-lib_map_path]
# usage: dem.sh [-noclean_files]
# usage: dem.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "dem.sh - Script generated by export_simulation (Vivado v2017.4 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_12 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dem xil_defaultlib.dem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dem -key {Behavioral:sim_1:Functional:dem} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./dem.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
{
  file="xsim.ini"
  lib_map_path="E:/GameDownload/Vivado/2017.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dem.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./dem.sh -help\" for more information)\n"
    exit 1
  fi
