...
#
# Generated by export_simulation on Fri Mar 24 09:48:30 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './dem.sh' script.
...
./dem.sh -noclean_files

For more information on the script, please type './dem.sh -help'.
